...
static std::map<NonTerminal, std::vector<Production>> productions = {
    ...
    {NonTerminal::stmt,
     {{NonTerminal::stmt,
      ...
      {NonTerminal::stmt, {Terminal::DELETE, NonTerminal::expr, Terminal::SEMI}}
     }},
    ...
    {NonTerminal::typeinit, {
        ...
        {NonTerminal::typeinit, {NonTerminal::type, Terminal::LBRACKET, NonTerminal::expr, Terminal::RBRACKET}},
    }}
};
